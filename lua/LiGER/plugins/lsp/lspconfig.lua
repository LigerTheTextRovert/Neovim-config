return {
  ...
  config = function()
    ...
    -- Global LSP keymaps (applied to every attached client)
    ...
    -- ──────────────────────────────────────────────────────────────
    -- Define only the servers you want to **customize**
    -- Mason-lspconfig + vim.lsp will auto-enable everything else
    -- ──────────────────────────────────────────────────────────────
    ...
    -- tailwindcss (most complex one you have)
    ...
    vim.lsp.config("pyright", {
      ...
      settings = {
        python = {
          pythonPath = vim.fn.getcwd() .. "/venv/bin/python", -- ← consider using pyenv/mise/venv selector instead
          analysis = {
